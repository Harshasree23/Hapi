...
userRoute.get('/',(req,res) => {return res.render('home');})
        ...
        .get('/editBadges', (req,res) => { res.render('editBadges'); } )  
        .get('/editCertifications',(req,res) => { res.render('editCertifications'); })
        .get('/editProjects', (req,res) => { res.render('editProjects'); })
        .get('/editSkills' , (req,res) => { res.render('editSkills'); })
